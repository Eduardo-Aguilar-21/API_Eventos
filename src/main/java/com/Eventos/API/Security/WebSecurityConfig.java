package com.Eventos.API.Security;

import com.Eventos.API.Security.filters.JwtAuthenticationFilter;
import com.Eventos.API.Security.filters.JwtAuthorizationFilter;
import com.Eventos.API.Security.jwt.JwtUtils;
import com.Eventos.API.Services.UserDetailsServiceImpl;
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity, AuthenticationManager authenticationManager) throws Exception {
        ...
        return httpSecurity
                ...
                .authorizeHttpRequests(auth -> {
                    ...
                    auth.requestMatchers("/api/eventos/**").permitAll();
                    auth.requestMatchers("/api/ec/**").permitAll();
